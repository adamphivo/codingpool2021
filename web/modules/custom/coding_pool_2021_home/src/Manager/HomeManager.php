...
namespace Drupal\coding_pool_2021_home\Manager;

use Drupal;
use Drupal\adimeo_tools\Service\LanguageService;
use Drupal\Core\Entity\EntityTypeManager;
use Drupal\coding_pool_2021_home\Gateway\HomeGateway;


class HomeManager
{
  const SERVICE_NAME = 'coding_pool_2021_home.home_manager';
